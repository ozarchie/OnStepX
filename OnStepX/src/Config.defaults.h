...
#endif
#ifndef STA_SSID
#define STA_SSID                      "TelstraB1F773"                      // Station SSID to connnect to
#endif
#ifndef STA_PASSWORD
#define STA_PASSWORD                  "guu8ru9q3f"                  // Wifi Station mode password
#endif
...
#define AXIS1_SENSE_LIMIT_INIT        LIMIT_SENSE_INIT            // pin mode for limit sensing
  ...
  #define AXIS1_ENCODER                 AB_ESP32             // type of encoder: AB, CW_CCW, PULSE_DIR, PULSE_ONLY, SERIAL_BRIDGE
  #endif
...
#define AXIS2_SENSE_LIMIT_INIT        LIMIT_SENSE_INIT            // pin mode for limit sensing
  ...
  #define AXIS2_ENCODER                 AB_ESP32 //AB
  #endif
