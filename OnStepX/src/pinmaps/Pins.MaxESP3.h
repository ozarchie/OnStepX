...
#ifdef ESP32S3
  #define I2C_SDA_PIN           8                // ESP32S3 I2C SDA pin
  #define I2C_SCL_PIN           9                // ESP32S3 I2C SCL pin
#else 
...
#define AXIS1_M0_PIN            42               // SPI MOSI
#define AXIS1_M1_PIN            41               // SPI SCK
...
#define AXIS1_DIR_PIN           10                // [must be high at boot 0]
...
#define AXIS2_M0_PIN            40               // SPI MOSI
#define AXIS2_M1_PIN            39               // SPI SCK
#define AXIS2_M2_PIN            5                // SPI CS (UART TX)
#if AXIS4_POWER_DOWN != ON
  #define AXIS2_M3_PIN          AUX2_PIN         // SPI MISO (UART RX)
#endif
#define AXIS2_STEP_PIN          17
#define AXIS2_DIR_PIN           11
